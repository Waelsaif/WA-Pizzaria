...
const navigation = useNavigation();
  return (
	  <View style={{ position: 'absolute', bottom: 0, height: 75, width: "100%", backgroundColor: "#f28aa5", borderTopLeftRadius: 30, borderTopRightRadius: 30, zIndex: 100 }}>
