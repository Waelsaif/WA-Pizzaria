...
function ShowItem({ route }) {
	...
	return (
		<View style={{ backgroundColor: "#FCEDCB", flex: 1, alignItems: "center" }}>
			<View style={{ backgroundColor: "#fff", width: "92%", marginTop: 70, paddingBottom: 20, borderRadius: 18 }}>
				...
				<View style={{ width: "90%", alignSelf: "center", }}>
					...
					<View style={{ flexDirection: 'row', gap: 10, alignItems: "center", marginTop: 18 }}>
						...
						<TouchableOpacity style={{ flex: 1, backgroundColor: "#f28aa5", borderRadius: 10, height: 50, justifyContent: "center", alignItems: "center" }}>
							<Text style={{ fontSize: 26, color: "#FCEDCB" }}>Add to Order</Text>
						</TouchableOpacity>
					</View>
				</View>
			</View>
